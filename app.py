...
def mostra_qntd_linhas(dataframe):
    ...
    qntd_linhas = st.sidebar.slider('Seleciona a quantidade de linhas que deseja mostrar na tabela', min_value=1, max_value=len(dataframe), step=1)
...
st.write('Nesse projeto vamos analisar a quantidade de produtos em estoque, por categoria, de uma base de dados de produtos de supermercados')

# Filtros para a tabela
checkbox_mostrar_tabela = st.sidebar.checkbox('Mostrar a tabela')
if checkbox_mostrar_tabela:
    ...
    categoria = st.sidebar.selectbox('Selecione a categoria para apresetar na tabela', options=categorias)
